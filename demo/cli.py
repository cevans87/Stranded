...
@funktools.Cli(flag_names=('-l, --log-level'))
def logging_flag(
    *,
    log_level: typing.Literal['CRITICAL', 'ERROR', 'WARNING', 'INFO', 'DEBUG', 'NOTSET'],
) -> None:
    """Set logging level."""
...
type Foo = tuple[tuple[Decroatee, Foo] | ()]


@typing.Cli()
def subcommand_flag(subcommand: typing.Literal['foo', 'bar', 'baz'], /) -> None:
    """These are subcommands"""


@typing.CLi(flag_names=('-l, --log-level'))
def log_level_flag(*, log_level: typing.Literal['CRITICAL', 'ERROR', 'WARNING', 'INFO', 'DEBUG']) -> None:
    """Set logging level."""
...
@funktools.Cli()
def main(
    subcommand: typing.Literal[
    ],
    /,
    log_level: typing.Annotated[
        funktools.Cli.LogLevel,
        lambda log_level: logger.setLevel(log_level),
    ],
) -> None:
    ...
...
@funktools.Cli()
def bar(
    bar: typing.Literal['foo', 'bar', 'baz'],
    /,
) -> None:
    """bar doc."""
    ...
...
@funktools.Cli(flags=('-c', '--subcommand'))
def subcommand(
    subcommand: typing.Literal['foo', 'bar', 'baz'],
    /,
) -> None:
    ...
