...
@dataclasses.dataclass(frozen=True, kw_only=True)
class ArgumentParser[**_Param, _Ret, _Decoratee, _Receive, _Send, _Exit, _Enter, _Decorated, _Decorator](
    decorator.Decorator[_Param, _Ret, _Decoratee, _Receive, _Send, _Exit, _Enter, Decorated, _Decorator],
    abc.ABC,
):
