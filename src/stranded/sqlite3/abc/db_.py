    ...
    def __call__(self, value: composer_.ValueT[ParamT, RetT], /) -> composer_.StackT:
        match value:
            ...
            case Param():
                ...
                return self.composer.Exit(enter=self, key=key), self.composee,  # type: ignore[call-arg]
...
# Aliases for annotation use. The Db ClassVars below shadow the class names within
# Db's scope, so annotations must reference these instead.
...
class Db[**ParamT, RetT](composer_.Composer[ParamT, RetT], abc.ABC):
    ...
    def __call__(self, composee: ComposeeT[ParamT, RetT], /) -> ComposedT[ParamT, RetT]:
        ...
        return self.Composed(  # type: ignore[return-value]
            ...
            composer=self,
            stack=(
                self.Enter(  # type: ignore[call-arg]
                    composer=self,
                    composee=composee,
