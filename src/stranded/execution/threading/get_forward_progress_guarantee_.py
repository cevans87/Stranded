...
type _Decorator[**_Param, _Ret] = GetForwardProgressGuarantee[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    get_forward_progress_guarantee_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Send[**_Param, _Ret](
    ...
    get_forward_progress_guarantee_.Send[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Receive[**_Param, _Ret](
    ...
    get_forward_progress_guarantee_.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Exit[**_Param, _Ret](
    ...
    get_forward_progress_guarantee_.Exit[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Enter[**_Param, _Ret](
    ...
    get_forward_progress_guarantee_.Enter[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    get_forward_progress_guarantee_.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class GetForwardProgressGuarantee[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
    ...
    get_forward_progress_guarantee_.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
