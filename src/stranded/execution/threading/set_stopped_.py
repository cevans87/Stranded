...
type _Decorator[**_Param, _Ret] = SetStopped[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    set_stopped_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
