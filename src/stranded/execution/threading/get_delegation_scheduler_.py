...
type _Decorator[**_Param, _Ret] = GetDelegationScheduler[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    get_delegation_scheduler_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Send[**_Param, _Ret](
    ...
    get_delegation_scheduler_.Send[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Receive[**_Param, _Ret](
    ...
    get_delegation_scheduler_.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Exit[**_Param, _Ret](
    ...
    get_delegation_scheduler_.Exit[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Enter[**_Param, _Ret](
    ...
    get_delegation_scheduler_.Enter[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    get_delegation_scheduler_.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class GetDelegationScheduler[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
    ...
    get_delegation_scheduler_.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
