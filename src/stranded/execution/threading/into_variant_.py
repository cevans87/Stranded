...
type _Decorator[**_Param, _Ret] = IntoVariant[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    into_variant_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
