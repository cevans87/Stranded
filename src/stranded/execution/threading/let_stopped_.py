...
type _Decorator[**_Param, _Ret] = LetStopped[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    let_stopped_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
