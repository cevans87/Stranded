...
type _Decorator[**_Param, _Ret] = StaticThreadPool[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    static_thread_pool_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class StaticThreadPool[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
