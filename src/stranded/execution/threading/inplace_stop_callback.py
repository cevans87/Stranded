...
class Decoratee[**_Param, _Ret](
    ...
    inplace_stop_callback.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Decorated[**_Param, _Ret](
    ...
    inplace_stop_callback.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorator[**_Param, _Ret](
    ...
    inplace_stop_callback.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
