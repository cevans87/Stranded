...
@_typing.overload
def __getattr__(name: _typing.Literal['ApplySender']) -> 'type[stranded.execution.threading.apply_sender.ApplySender]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['as_awaitable']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['AsAwaitable']) -> 'type[stranded.execution.threading.as_awaitable.AsAwaitable]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['bulk']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Bulk']) -> 'type[stranded.execution.threading.bulk.Bulk]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['bulk_chunked']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['BulkChunked']) -> 'type[stranded.execution.threading.bulk_chunked.BulkChunked]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['bulk_unchunked']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['BulkUnchunked']) -> 'type[stranded.execution.threading.bulk_unchunked.BulkUnchunked]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['connect']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Connect']) -> 'type[stranded.execution.threading.connect.Connect]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['continues_on']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['ContinuesOn']) -> 'type[stranded.execution.threading.continues_on.ContinuesOn]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['default_domain']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['DefaultDomain']) -> 'type[stranded.execution.threading.default_domain.DefaultDomain]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['empty_env']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['EmptyEnv']) -> 'type[stranded.execution.threading.empty_env.EmptyEnv]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['ensure_started']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['EnsureStarted']) -> 'type[stranded.execution.threading.ensure_started.EnsureStarted]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['env']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Env']) -> 'type[stranded.execution.threading.env.Env]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['forwarding_query']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['ForwardingQuery']) -> 'type[stranded.execution.threading.forwarding_query.ForwardingQuery]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_allocator']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetAllocator']) -> 'type[stranded.execution.threading.get_allocator.GetAllocator]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_completion_scheduler']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetCompletionScheduler']) -> 'type[stranded.execution.threading.get_completion_scheduler.GetCompletionScheduler]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_completion_signatures']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetCompletionSignatures']) -> 'type[stranded.execution.threading.get_completion_signatures.GetCompletionSignatures]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_delegation_scheduler']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetDelegationScheduler']) -> 'type[stranded.execution.threading.get_delegation_scheduler.GetDelegationScheduler]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_domain']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetDomain']) -> 'type[stranded.execution.threading.get_domain.GetDomain]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_env']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetEnv']) -> 'type[stranded.execution.threading.get_env.GetEnv]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_forward_progress_guarantee']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetForwardProgressGuarantee']) -> 'type[stranded.execution.threading.get_forward_progress_guarantee.GetForwardProgressGuarantee]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_scheduler']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetScheduler']) -> 'type[stranded.execution.threading.get_scheduler.GetScheduler]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['get_stop_token']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['GetStopToken']) -> 'type[stranded.execution.threading.get_stop_token.GetStopToken]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['inline_scheduler']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['InlineScheduler']) -> 'type[stranded.execution.threading.inline_scheduler.InlineScheduler]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['inplace_stop_callback']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['InplaceStopCallback']) -> 'type[stranded.execution.threading.inplace_stop_callback.InplaceStopCallback]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['inplace_stop_source']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['InplaceStopSource']) -> 'type[stranded.execution.threading.inplace_stop_source.InplaceStopSource]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['inplace_stop_token']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['InplaceStopToken']) -> 'type[stranded.execution.threading.inplace_stop_token.InplaceStopToken]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['into_variant']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['IntoVariant']) -> 'type[stranded.execution.threading.into_variant.IntoVariant]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['just']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Just']) -> 'type[stranded.execution.threading.just.Just]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['just_error']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['JustError']) -> 'type[stranded.execution.threading.just_error.JustError]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['just_stopped']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['JustStopped']) -> 'type[stranded.execution.threading.just_stopped.JustStopped]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['let_error']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['LetError']) -> 'type[stranded.execution.threading.let_error.LetError]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['let_stopped']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['LetStopped']) -> 'type[stranded.execution.threading.let_stopped.LetStopped]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['let_value']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['LetValue']) -> 'type[stranded.execution.threading.let_value.LetValue]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['never_stop_token']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['NeverStopToken']) -> 'type[stranded.execution.threading.never_stop_token.NeverStopToken]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['operation_state']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['OperationState']) -> 'type[stranded.execution.threading.operation_state.OperationState]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['prop']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Prop']) -> 'type[stranded.execution.threading.prop.Prop]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['read_env']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['ReadEnv']) -> 'type[stranded.execution.threading.read_env.ReadEnv]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['receiver']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Receiver']) -> 'type[stranded.execution.threading.receiver.Receiver]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['run_loop']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['RunLoop']) -> 'type[stranded.execution.threading.run_loop.RunLoop]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['schedule']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Schedule']) -> 'type[stranded.execution.threading.schedule.Schedule]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['schedule_from']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['ScheduleFrom']) -> 'type[stranded.execution.threading.schedule_from.ScheduleFrom]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['scheduler']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Scheduler']) -> 'type[stranded.execution.threading.scheduler.Scheduler]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['sender']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Sender']) -> 'type[stranded.execution.threading.sender.Sender]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['set_error']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SetError']) -> 'type[stranded.execution.threading.set_error.SetError]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['set_stopped']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SetStopped']) -> 'type[stranded.execution.threading.set_stopped.SetStopped]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['set_value']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SetValue']) -> 'type[stranded.execution.threading.set_value.SetValue]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['split']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Split']) -> 'type[stranded.execution.threading.split.Split]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['start']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Start']) -> 'type[stranded.execution.threading.start.Start]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['start_detached']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StartDetached']) -> 'type[stranded.execution.threading.start_detached.StartDetached]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['starts_on']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StartsOn']) -> 'type[stranded.execution.threading.starts_on.StartsOn]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['static_thread_pool']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StaticThreadPool']) -> 'type[stranded.execution.threading.static_thread_pool.StaticThreadPool]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stop_callback']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StopCallback']) -> 'type[stranded.execution.threading.stop_callback.StopCallback]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stop_source']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StopSource']) -> 'type[stranded.execution.threading.stop_source.StopSource]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stop_token']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StopToken']) -> 'type[stranded.execution.threading.stop_token.StopToken]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stopped']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Stopped']) -> 'type[stranded.execution.threading.stopped.Stopped]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stopped_as_error']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StoppedAsError']) -> 'type[stranded.execution.threading.stopped_as_error.StoppedAsError]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['stopped_as_optional']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['StoppedAsOptional']) -> 'type[stranded.execution.threading.stopped_as_optional.StoppedAsOptional]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['sync_wait']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SyncWait']) -> 'type[stranded.execution.threading.sync_wait.SyncWait]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['sync_wait_with_variant']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SyncWaitWithVariant']) -> 'type[stranded.execution.threading.sync_wait_with_variant.SyncWaitWithVariant]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['system_context']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['SystemContext']) -> 'type[stranded.execution.threading.system_context.SystemContext]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['then']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Then']) -> 'type[stranded.execution.threading.then.Then]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['transform_env']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['TransformEnv']) -> 'type[stranded.execution.threading.transform_env.TransformEnv]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['transform_sender']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['TransformSender']) -> 'type[stranded.execution.threading.transform_sender.TransformSender]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['upon_error']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['UponError']) -> 'type[stranded.execution.threading.upon_error.UponError]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['upon_stopped']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['UponStopped']) -> 'type[stranded.execution.threading.upon_stopped.UponStopped]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['when_all']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['WhenAll']) -> 'type[stranded.execution.threading.when_all.WhenAll]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['when_all_with_variant']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['WhenAllWithVariant']) -> 'type[stranded.execution.threading.when_all_with_variant.WhenAllWithVariant]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['with_awaitable_senders']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['WithAwaitableSenders']) -> 'type[stranded.execution.threading.with_awaitable_senders.WithAwaitableSenders]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['with_query_value']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['WithQueryValue']) -> 'type[stranded.execution.threading.with_query_value.WithQueryValue]': ...
