...
class Decoratee[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Send[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Send[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Receive[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Exit[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Exit[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Enter[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Enter[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorator[**_Param, _Ret](
    ...
    get_forward_progress_guarantee.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
