...
type _Decorator[**_Param, _Ret] = ContinuesOn[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    continues_on_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
