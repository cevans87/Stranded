...
type _Decorator[**_Param, _Ret] = UponStopped[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    upon_stopped_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
