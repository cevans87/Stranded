...
type _Decorator[**_Param, _Ret] = JustError[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    just_error_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
