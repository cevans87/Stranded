...
type _Decorator[**_Param, _Ret] = TransformSender[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    transform_sender_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class TransformSender[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
