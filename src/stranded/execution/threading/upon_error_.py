...
type _Decorator[**_Param, _Ret] = UponError[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    upon_error_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
