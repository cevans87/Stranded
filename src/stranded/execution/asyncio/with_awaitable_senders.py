...
class Decoratee[**_Param, _Ret](
    ...
    with_awaitable_senders.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Receive[**_Param, _Ret](
    ...
    with_awaitable_senders.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    with_awaitable_senders.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorator[**_Param, _Ret](
    ...
    with_awaitable_senders.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
