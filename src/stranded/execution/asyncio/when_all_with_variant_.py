...
type _Decorator[**_Param, _Ret] = WhenAllWithVariant[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    when_all_with_variant_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Receive[**_Param, _Ret](
    ...
    when_all_with_variant_.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    when_all_with_variant_.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class WhenAllWithVariant[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
    ...
    when_all_with_variant_.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
