...
type _Decorator[**_Param, _Ret] = GetDomain[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    get_domain_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
