...
type _Decorator[**_Param, _Ret] = AsAwaitable[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    as_awaitable_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
