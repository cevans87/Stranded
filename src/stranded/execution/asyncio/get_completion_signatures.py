...
from ..abc import get_completion_signatures
...
class Decoratee[**_Param, _Ret](
    ...
    get_completion_signatures.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Send[**_Param, _Ret](
    ...
    get_completion_signatures.Send[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Receive[**_Param, _Ret](
    ...
    get_completion_signatures.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Exit[**_Param, _Ret](
    ...
    get_completion_signatures.Exit[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Enter[**_Param, _Ret](
    ...
    get_completion_signatures.Enter[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    get_completion_signatures.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorator[**_Param, _Ret](
    ...
    get_completion_signatures.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
GetCompletionSignatures = Decorator
