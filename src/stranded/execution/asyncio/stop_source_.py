...
class Decoratee[**ParamT, RetT](
    ...
    stop_source_.Decoratee[ParamT, RetT],
    typing.Protocol,
): ...
...
class Receive[**ParamT, RetT](
    ...
    stop_source_.Receive[ParamT, RetT],
): ...
...
class Enter[**ParamT, RetT](
    ...
    stop_source_.Enter[ParamT, RetT],
): ...
...
class Decorated[**ParamT, RetT](
    ...
    stop_source_.Decorated[ParamT, RetT],
): ...


@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class StopSource[**ParamT, RetT](
    decorator.Decorator[ParamT, RetT],
    stop_source_.Decorator[ParamT, RetT],
):
