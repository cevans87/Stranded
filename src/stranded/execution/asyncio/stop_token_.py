...
type _Decorator[**_Param, _Ret] = StopToken[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    stop_token_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
