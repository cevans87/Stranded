...
class Decoratee[**ParamT, RetT](
    ...
    just_stopped_.Decoratee[ParamT, RetT],
    typing.Protocol,
): ...
...
class Send[**ParamT, RetT](
    ...
    just_stopped_.Send[ParamT, RetT],
): ...
...
class Receive[**ParamT, RetT](
    ...
    just_stopped_.Receive[ParamT, RetT],
): ...
...
class Exit[**ParamT, RetT](
    ...
    just_stopped_.Exit[ParamT, RetT],
): ...
...
class Enter[**ParamT, RetT](
    ...
    just_stopped_.Enter[ParamT, RetT],
): ...
...
class Decorated[**ParamT, RetT](
    ...
    just_stopped_.Decorated[ParamT, RetT],
): ...


@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class JustStopped[**ParamT, RetT](
    decorator.Decorator[ParamT, RetT],
    just_stopped_.Decorator[ParamT, RetT],
):
