...
class Decoratee[**_Param, _Ret](
    ...
    sync_wait_with_variant.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Receive[**_Param, _Ret](
    ...
    sync_wait_with_variant.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    sync_wait_with_variant.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorator[**_Param, _Ret](
    ...
    sync_wait_with_variant.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
