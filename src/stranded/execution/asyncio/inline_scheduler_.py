...
type _Decorator[**_Param, _Ret] = InlineScheduler[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    inline_scheduler_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class InlineScheduler[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
