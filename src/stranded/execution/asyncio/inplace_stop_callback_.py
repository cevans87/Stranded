...
type _Decorator[**_Param, _Ret] = InplaceStopCallback[_Param, _Ret]


@typing.runtime_checkable
class Decoratee[**_Param, _Ret](
    decorator.Decoratee[_Param, _Ret],
    inplace_stop_callback_.Decoratee[_Param, _Ret],
    typing.Protocol,
): ...
...
class Receive[**_Param, _Ret](
    ...
    inplace_stop_callback_.Receive[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
class Decorated[**_Param, _Ret](
    ...
    inplace_stop_callback_.Decorated[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
...
@typing.final
@dataclasses.dataclass(frozen=True, kw_only=True)
class InplaceStopCallback[**_Param, _Ret](
    decorator.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
    ...
    inplace_stop_callback_.Decorator[
        _Param,
        _Ret,
        _Decoratee[_Param, _Ret],
        _Receive[_Param, _Ret],
