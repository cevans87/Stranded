...
class Send[**ParamT, RetT](
    ...
    bulk_chunked_.Send[ParamT, RetT],
): ...
...
class Receive[**ParamT, RetT](
    ...
    bulk_chunked_.Receive[ParamT, RetT],
): ...
...
class Exit[**ParamT, RetT](
    ...
    bulk_chunked_.Exit[ParamT, RetT],
): ...
...
class Enter[**ParamT, RetT](
    ...
    bulk_chunked_.Enter[ParamT, RetT],
): ...
...
class Decorated[**ParamT, RetT](
    ...
    bulk_chunked_.Decorated[ParamT, RetT],
): ...
...
class BulkChunked[**ParamT, RetT](
    ...
    bulk_chunked_.Decorator[ParamT, RetT],
):
