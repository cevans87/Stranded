...
@_typing.overload
def __getattr__(name: _typing.Literal['LruCache']) -> 'type[stranded.functools.asyncio.lru_cache.LruCache]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['retry']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Retry']) -> 'type[stranded.functools.asyncio.retry.Retry]': ...
@_typing.overload
def __getattr__(name: _typing.Literal['throttle']) -> _types.ModuleType: ...
@_typing.overload
def __getattr__(name: _typing.Literal['Throttle']) -> 'type[stranded.functools.asyncio.throttle.Throttle]': ...
